...
bin/generate_pythia_zpole_root   --Output "${OUTPUT}"   --Events "${EVENTS}"   --Seed "${SEED}"   --PythiaData "${PYTHIA8DATA}"   --EnableShoving 1   --ApplyAlephLikeAcceptance 0   --ReportEvery 50000   2>&1 | tee "${LOG}"
